...
ents.COMPONENT_MONSTER_SITTING_SCIENTIST = ents.register_component("monster_sitting_scientist",ents.MonsterSittingScientist,ents.EntityComponent.FREGISTER_BIT_NETWORKED)
