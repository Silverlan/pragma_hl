...
local cvHealth = console.register_variable(
	...
	"Specifies barney's default health."
)
...
ents.register_component("monster_barney", ents.MonsterBarney, "hl", ents.EntityComponent.FREGISTER_BIT_NETWORKED)
