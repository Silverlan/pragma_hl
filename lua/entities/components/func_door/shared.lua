...
ents.FuncDoor:RegisterMember("Open",ents.MEMBER_TYPE_BOOLEAN,false,{},bit.bor(defaultMemberFlags,ents.BaseEntityComponent.MEMBER_FLAG_BIT_USE_IS_GETTER))
...
ents.FuncDoor:RegisterMember("SpawnPosition",ents.MEMBER_TYPE_UINT8,ents.FuncDoor.SPAWN_POSITION_CLOSED,{},defaultMemberFlags)
ents.FuncDoor:RegisterMember("LockedSentence",ents.MEMBER_TYPE_UINT8,ents.FuncDoor.LOCKED_SENTENCE_NONE,{},defaultMemberFlags)
ents.FuncDoor:RegisterMember("UnlockedSentence",ents.MEMBER_TYPE_UINT8,ents.FuncDoor.UNLOCKED_SENTENCE_NONE,{},defaultMemberFlags)
...
ents.FuncDoor:RegisterMember("Locked",ents.MEMBER_TYPE_BOOLEAN,false,{},bit.bor(defaultMemberFlags,ents.BaseEntityComponent.MEMBER_FLAG_BIT_USE_IS_GETTER))
