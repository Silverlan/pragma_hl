...
ents.FuncTrackTrain:RegisterMember("ManualAccelerationSpeed",util.VAR_TYPE_FLOAT,0.0,defaultMemberFlagsNw,1)
ents.FuncTrackTrain:RegisterMember("ManualDecelerationSpeed",util.VAR_TYPE_FLOAT,0.0,defaultMemberFlagsNw,1)

ents.FuncTrackTrain:RegisterMember("MovePingSound",util.VAR_TYPE_STRING,"",defaultMemberFlags,1)
ents.FuncTrackTrain:RegisterMember("MoveSoundMinPitch",util.VAR_TYPE_FLOAT,0.0,defaultMemberFlags,1)
ents.FuncTrackTrain:RegisterMember("MoveSoundMaxPitch",util.VAR_TYPE_FLOAT,0.0,defaultMemberFlags,1)
ents.FuncTrackTrain:RegisterMember("MoveSoundMinTime",util.VAR_TYPE_FLOAT,0.0,defaultMemberFlags,1)
ents.FuncTrackTrain:RegisterMember("MoveSoundMaxTime",util.VAR_TYPE_FLOAT,0.0,defaultMemberFlags,1)
ents.FuncTrackTrain:RegisterMember("FirstStopTarget",util.VAR_TYPE_STRING,"",defaultMemberFlags,1)

ents.FuncTrackTrain:RegisterMember("WheelDistance",util.VAR_TYPE_FLOAT,0.0,defaultMemberFlagsNw,1)
ents.FuncTrackTrain:RegisterMember("Bank",util.VAR_TYPE_FLOAT,0.0,defaultMemberFlagsNw,1)

ents.FuncTrackTrain:RegisterMember("IOControlled",util.VAR_TYPE_BOOL,false,defaultMemberFlagsNw,1)
ents.FuncTrackTrain:RegisterMember("CrushDamage",util.VAR_TYPE_INT32,0,defaultMemberFlags,1)
ents.FuncTrackTrain:RegisterMember("CurrentTarget",util.VAR_TYPE_ENTITY,ents.get_null(),defaultMemberFlagsNw,1)
ents.FuncTrackTrain:RegisterMember("SpawnFlags",util.VAR_TYPE_UINT32,0,defaultMemberFlags,1)
