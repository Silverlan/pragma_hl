...
ents.KinematicMover:RegisterMember("MoveRelative",util.VAR_TYPE_BOOL,false,defaultMemberFlagsNw,1)
ents.KinematicMover:RegisterMember("MoveTarget",util.VAR_TYPE_VECTOR,Vector(),defaultMemberFlagsNw,1)
ents.KinematicMover:RegisterMember("MoveState",util.VAR_TYPE_UINT8,ents.KinematicMover.MOVE_STATE_IDLE,defaultMemberFlagsNw,1)
ents.KinematicMover:RegisterMember("MaxSpeed",util.VAR_TYPE_FLOAT,math.huge,defaultMemberFlagsNw,1)
ents.KinematicMover:RegisterMember("StartSpeed",util.VAR_TYPE_FLOAT,0.0,defaultMemberFlagsNw,1)
ents.KinematicMover:RegisterMember("Speed",util.VAR_TYPE_FLOAT,0.0,bit.bor(defaultMemberFlagsNw,ents.BaseEntityComponent.MEMBER_FLAG_BIT_PROPERTY),1)
ents.KinematicMover:RegisterMember("VelocityType",util.VAR_TYPE_UINT8,ents.KinematicMover.VELOCITY_TYPE_INSTANTANEOUSLY,defaultMemberFlagsNw,1)
ents.KinematicMover:RegisterMember("OrientationType",util.VAR_TYPE_UINT8,ents.KinematicMover.ORIENTATION_TYPE_NEVER,defaultMemberFlagsNw,1)
ents.KinematicMover:RegisterMember("ForwardSpeedModifier",util.VAR_TYPE_FLOAT,1.0,defaultMemberFlagsNw,1)
ents.KinematicMover:RegisterMember("HeightOffset",util.VAR_TYPE_FLOAT,0.0,defaultMemberFlagsNw,1)

ents.KinematicMover:RegisterMember("MoveSoundName",util.VAR_TYPE_STRING,"",defaultMemberFlags,1)
ents.KinematicMover:RegisterMember("LoopMovingSound",util.VAR_TYPE_BOOL,true,defaultMemberFlags,1)
ents.KinematicMover:RegisterMember("StartSound",util.VAR_TYPE_STRING,"",defaultMemberFlags,1)
ents.KinematicMover:RegisterMember("StopSound",util.VAR_TYPE_STRING,"",defaultMemberFlags,1)
ents.KinematicMover:RegisterMember("SoundVolume",util.VAR_TYPE_FLOAT,1.0,defaultMemberFlags,1)
